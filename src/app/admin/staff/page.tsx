              ...
              {filteredStaff.map((s) => (
                ...
                >
                  ...
                  <td className="px-6 md:px-10 py-5 md:py-7 text-center">
                    <span className={`px-2 md:px-3 py-1 md:py-1.5 rounded-lg text-[9px] md:text-[10px] font-black uppercase tracking-widest ${s.role === 'owner' ? "bg-purple-50 text-purple-700 ring-1 ring-purple-100" :
