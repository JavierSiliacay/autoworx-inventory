...
export default function ReceivablesPage() {
  ...
  const openRecordDetails = async (record: ReceivableRecord) => {
  ...
  const activeAccounts = records.filter(r => r.status !== 'Paid').length;
  ...
  return (
    <div className="pb-20" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-8 md:mb-12">
        <div>
          <h1 className="text-3xl md:text-5xl font-manrope font-extrabold tracking-tight text-[#1e40af] mb-2">Accounts Receivable</h1>
          ...
          <div className="bg-white rounded-[2.5rem] w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl animate-in zoom-in-95 duration-300 border border-white/20">
             <div className="px-10 py-10 bg-slate-50 border-b border-slate-100 flex justify-between items-center sticky top-0 z-10">
                <div className="flex items-center gap-5">
                   ...
                   <div>
                      <h2 className="text-2xl font-manrope font-extrabold text-[#111827]">Settle Account Balance</h2>
