  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 p-6 flex flex-col items-center justify-center text-white relative">
          <button 
        ...
        <div className="p-6 sm:p-8 bg-white">
          ...
          <button 
            onClick={() => setAnnouncement(null)}
            className="mt-8 w-full bg-slate-100 hover:bg-slate-200 text-slate-800 font-bold py-3 rounded-xl transition-colors"
          >
            Acknowledge & Close
          </button>
        </div>
