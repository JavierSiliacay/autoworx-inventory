...
BEGIN
  ...
  IF b_id IS NULL THEN
    SELECT id INTO b_id FROM public.branches LIMIT 1;
  END IF;
  ...
  IF FOUND THEN
    ...
    VALUES (inv_id, 24, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'CSI-004306' || ')', COALESCE('2026-06-13', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 3, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'CSI-004306' || ')', COALESCE('2026-06-13', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 2, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'CSI-004306' || ')', COALESCE('2026-06-13', timezone('utc'::text, now())));
  END IF;
  SELECT id INTO inv_id FROM public.inventory WHERE sku = 'SOB757' AND branch_id = b_id LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.sales (date, invoice_no, customer_name, payment_type, branch_id, item_id, quantity, unit_price, unit_cost, total_amount, performed_by, created_at)
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 30, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'CSI-004307' || ')', COALESCE('2026-06-15', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 6, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'CSI-004307' || ')', COALESCE('2026-06-15', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 1, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'CSI-004308' || ')', COALESCE('2026-06-16', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 4, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'CSI-004308' || ')', COALESCE('2026-06-16', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 60, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'CSI-004309' || ')', COALESCE('2026-06-16', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 48, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'CSI-004310' || ')', COALESCE('2026-06-18', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 48, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1385' || ')', COALESCE('2026-06-20', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 8, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1385' || ')', COALESCE('2026-06-20', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 24, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1385' || ')', COALESCE('2026-06-20', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 4, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1385' || ')', COALESCE('2026-06-20', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 50, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1385' || ')', COALESCE('2026-06-20', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 10, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1385' || ')', COALESCE('2026-06-20', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 2, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1385' || ')', COALESCE('2026-06-20', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 30, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1385' || ')', COALESCE('2026-06-20', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 12, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1385' || ')', COALESCE('2026-06-20', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 8, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1383' || ')', COALESCE('2026-06-20', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 240, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1383' || ')', COALESCE('2026-06-20', timezone('utc'::text, now())));
  END IF;
  SELECT id INTO inv_id FROM public.inventory WHERE sku = 'MT203' AND branch_id = b_id LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.sales (date, invoice_no, customer_name, payment_type, branch_id, item_id, quantity, unit_price, unit_cost, total_amount, performed_by, created_at)
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 4, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1383' || ')', COALESCE('2026-06-20', timezone('utc'::text, now())));
  END IF;
  SELECT id INTO inv_id FROM public.inventory WHERE sku = 'NAX108' AND branch_id = b_id LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.sales (date, invoice_no, customer_name, payment_type, branch_id, item_id, quantity, unit_price, unit_cost, total_amount, performed_by, created_at)
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 120, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1383' || ')', COALESCE('2026-06-20', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 3, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1383' || ')', COALESCE('2026-06-20', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 60, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1383' || ')', COALESCE('2026-06-20', timezone('utc'::text, now())));
  END IF;
  SELECT id INTO inv_id FROM public.inventory WHERE sku = 'DOMBF-4L' AND branch_id = b_id LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.sales (date, invoice_no, customer_name, payment_type, branch_id, item_id, quantity, unit_price, unit_cost, total_amount, performed_by, created_at)
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 24, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1383' || ')', COALESCE('2026-06-20', timezone('utc'::text, now())));
  END IF;
  SELECT id INTO inv_id FROM public.inventory WHERE sku = 'TOBF-4L' AND branch_id = b_id LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.sales (date, invoice_no, customer_name, payment_type, branch_id, item_id, quantity, unit_price, unit_cost, total_amount, performed_by, created_at)
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 20, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1383' || ')', COALESCE('2026-06-20', timezone('utc'::text, now())));
  END IF;
  SELECT id INTO inv_id FROM public.inventory WHERE sku = 'SOB757' AND branch_id = b_id LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.sales (date, invoice_no, customer_name, payment_type, branch_id, item_id, quantity, unit_price, unit_cost, total_amount, performed_by, created_at)
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 400, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1383' || ')', COALESCE('2026-06-20', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 12, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1383' || ')', COALESCE('2026-06-20', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 5, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1383' || ')', COALESCE('2026-06-20', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 500, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1384' || ')', COALESCE('2026-06-20', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 10, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1384' || ')', COALESCE('2026-06-20', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 12, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1384' || ')', COALESCE('2026-06-20', timezone('utc'::text, now())));
  END IF;
  SELECT id INTO inv_id FROM public.inventory WHERE sku = 'MSC' AND branch_id = b_id LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.sales (date, invoice_no, customer_name, payment_type, branch_id, item_id, quantity, unit_price, unit_cost, total_amount, performed_by, created_at)
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 40, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1386' || ')', COALESCE('2026-06-24', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 2, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1386' || ')', COALESCE('2026-06-24', timezone('utc'::text, now())));
  END IF;
  SELECT id INTO inv_id FROM public.inventory WHERE sku = 'DOMBF-4L' AND branch_id = b_id LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.sales (date, invoice_no, customer_name, payment_type, branch_id, item_id, quantity, unit_price, unit_cost, total_amount, performed_by, created_at)
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 20, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1386' || ')', COALESCE('2026-06-24', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 4, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1386' || ')', COALESCE('2026-06-24', timezone('utc'::text, now())));
  END IF;
  SELECT id INTO inv_id FROM public.inventory WHERE sku = 'NAX108' AND branch_id = b_id LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.sales (date, invoice_no, customer_name, payment_type, branch_id, item_id, quantity, unit_price, unit_cost, total_amount, performed_by, created_at)
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 48, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1386' || ')', COALESCE('2026-06-24', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 300, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1386' || ')', COALESCE('2026-06-24', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 50, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1386' || ')', COALESCE('2026-06-24', timezone('utc'::text, now())));
  END IF;
  SELECT id INTO inv_id FROM public.inventory WHERE sku = 'EPOXYTHNR-4L' AND branch_id = b_id LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.sales (date, invoice_no, customer_name, payment_type, branch_id, item_id, quantity, unit_price, unit_cost, total_amount, performed_by, created_at)
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 6, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1386' || ')', COALESCE('2026-06-24', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 24, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1386' || ')', COALESCE('2026-06-24', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 3, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1386' || ')', COALESCE('2026-06-24', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 1, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1387' || ')', COALESCE('2026-06-24', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 2, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1387' || ')', COALESCE('2026-06-24', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 12, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1387' || ')', COALESCE('2026-06-24', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 6, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1387' || ')', COALESCE('2026-06-24', timezone('utc'::text, now())));
  END IF;
  SELECT id INTO inv_id FROM public.inventory WHERE sku = 'PRI3634' AND branch_id = b_id LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.sales (date, invoice_no, customer_name, payment_type, branch_id, item_id, quantity, unit_price, unit_cost, total_amount, performed_by, created_at)
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 36, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1387' || ')', COALESCE('2026-06-24', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 8, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1387' || ')', COALESCE('2026-06-24', timezone('utc'::text, now())));
  END IF;
  SELECT id INTO inv_id FROM public.inventory WHERE sku = 'EA120' AND branch_id = b_id LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.sales (date, invoice_no, customer_name, payment_type, branch_id, item_id, quantity, unit_price, unit_cost, total_amount, performed_by, created_at)
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 300, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1387' || ')', COALESCE('2026-06-24', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 200, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1387' || ')', COALESCE('2026-06-24', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 5, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'CSI-004311' || ')', COALESCE('2026-06-24', timezone('utc'::text, now())));
  END IF;
  SELECT id INTO inv_id FROM public.inventory WHERE sku = 'DOMBF-4L' AND branch_id = b_id LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.sales (date, invoice_no, customer_name, payment_type, branch_id, item_id, quantity, unit_price, unit_cost, total_amount, performed_by, created_at)
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 8, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'CSI-004311' || ')', COALESCE('2026-06-24', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 27, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'CSI-004311' || ')', COALESCE('2026-06-24', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 1, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'CSI-004313' || ')', COALESCE('2026-06-25', timezone('utc'::text, now())));
  END IF;
  SELECT id INTO inv_id FROM public.inventory WHERE sku = 'TOBF-4L' AND branch_id = b_id LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.sales (date, invoice_no, customer_name, payment_type, branch_id, item_id, quantity, unit_price, unit_cost, total_amount, performed_by, created_at)
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 8, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'CSI-004312' || ')', COALESCE('2026-06-25', timezone('utc'::text, now())));
  END IF;
  SELECT id INTO inv_id FROM public.inventory WHERE sku = 'PRI3634' AND branch_id = b_id LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.sales (date, invoice_no, customer_name, payment_type, branch_id, item_id, quantity, unit_price, unit_cost, total_amount, performed_by, created_at)
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 48, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'CSI-004312' || ')', COALESCE('2026-06-25', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 24, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'CSI-004314' || ')', COALESCE('2026-06-26', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 12, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'CSI-004314' || ')', COALESCE('2026-06-26', timezone('utc'::text, now())));
  END IF;
  SELECT id INTO inv_id FROM public.inventory WHERE sku = 'DOMBF-1L' AND branch_id = b_id LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.sales (date, invoice_no, customer_name, payment_type, branch_id, item_id, quantity, unit_price, unit_cost, total_amount, performed_by, created_at)
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 12, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'CSI-15413' || ')', COALESCE('2026-06-27', timezone('utc'::text, now())));
  END IF;
  SELECT id INTO inv_id FROM public.inventory WHERE sku = 'DOMBF-4L' AND branch_id = b_id LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.sales (date, invoice_no, customer_name, payment_type, branch_id, item_id, quantity, unit_price, unit_cost, total_amount, performed_by, created_at)
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 4, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'CSI-15413' || ')', COALESCE('2026-06-27', timezone('utc'::text, now())));
  END IF;
  SELECT id INTO inv_id FROM public.inventory WHERE sku = 'EPOXYTHNR-4L' AND branch_id = b_id LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.sales (date, invoice_no, customer_name, payment_type, branch_id, item_id, quantity, unit_price, unit_cost, total_amount, performed_by, created_at)
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 25, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1388' || ')', COALESCE('2026-06-29', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 500, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1388' || ')', COALESCE('2026-06-29', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 120, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1388' || ')', COALESCE('2026-06-29', timezone('utc'::text, now())));
  END IF;
  SELECT id INTO inv_id FROM public.inventory WHERE sku = 'SOB757' AND branch_id = b_id LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.sales (date, invoice_no, customer_name, payment_type, branch_id, item_id, quantity, unit_price, unit_cost, total_amount, performed_by, created_at)
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 60, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1388' || ')', COALESCE('2026-06-29', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 36, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1388' || ')', COALESCE('2026-06-29', timezone('utc'::text, now())));
  END IF;
  SELECT id INTO inv_id FROM public.inventory WHERE sku = 'NXU4075-4L' AND branch_id = b_id LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.sales (date, invoice_no, customer_name, payment_type, branch_id, item_id, quantity, unit_price, unit_cost, total_amount, performed_by, created_at)
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 12, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1388' || ')', COALESCE('2026-06-29', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 4, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1388' || ')', COALESCE('2026-06-29', timezone('utc'::text, now())));
  END IF;
  SELECT id INTO inv_id FROM public.inventory WHERE sku = 'ROBRC-1KG' AND branch_id = b_id LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.sales (date, invoice_no, customer_name, payment_type, branch_id, item_id, quantity, unit_price, unit_cost, total_amount, performed_by, created_at)
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 30, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1388' || ')', COALESCE('2026-06-29', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 6, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1388' || ')', COALESCE('2026-06-29', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 5, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1388' || ')', COALESCE('2026-06-29', timezone('utc'::text, now())));
  END IF;
  SELECT id INTO inv_id FROM public.inventory WHERE sku = 'DOMBF-1L' AND branch_id = b_id LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.sales (date, invoice_no, customer_name, payment_type, branch_id, item_id, quantity, unit_price, unit_cost, total_amount, performed_by, created_at)
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 24, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1388' || ')', COALESCE('2026-06-29', timezone('utc'::text, now())));
  END IF;
  SELECT id INTO inv_id FROM public.inventory WHERE sku = 'EA120' AND branch_id = b_id LIMIT 1;
  IF FOUND THEN
    INSERT INTO public.sales (date, invoice_no, customer_name, payment_type, branch_id, item_id, quantity, unit_price, unit_cost, total_amount, performed_by, created_at)
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 300, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1389' || ')', COALESCE('2026-06-29', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 200, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1389' || ')', COALESCE('2026-06-29', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 6, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1389' || ')', COALESCE('2026-06-29', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 4, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1389' || ')', COALESCE('2026-06-29', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 36, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'DR-1389' || ')', COALESCE('2026-06-29', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 4, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'CSI-15430' || ')', COALESCE('2026-06-29', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 2, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'CSI-15430' || ')', COALESCE('2026-06-29', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 3, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'CSI-15430' || ')', COALESCE('2026-06-29', timezone('utc'::text, now())));
  END IF;
  ...
  IF FOUND THEN
    ...
    INSERT INTO public.transactions (item_id, quantity, transaction_type, module_type, performed_by, remarks, timestamp)
    VALUES (inv_id, 1, 'outbound', 'paints', '00000000-0000-0000-0000-000000000000', 'Historical Sale Migration (Inv: ' || 'CSI-15430' || ')', COALESCE('2026-06-29', timezone('utc'::text, now())));
  END IF;
END
$$;
